...
public class TheTruthAboutInsurance {
	...
	private String fileName_Excel = "thetruthaboutinsurance.xlsx";
	...
	private void validate_TopMDAEnterButton(String urlString, String dropDownOption)
		...
		if (bit) {
			...
			System.out.println("No MDA present on HomePage. Skipping!!!!");
		} else {
	...
	private void validate_TopMDA(String urlString, String dropDownOption)
		...
		if (bit) {
			...
			System.out.println("No Top MDA on TheTruthAboutInsurance. Skipping!!!!!!");
		} else {
