...
public class NoFaultInsuranceQuotes {
	...
	private String fileName_Excel = "nofaultinsurancequotes.xlsx";
	...
	public void validate_TopMDA(String urlString) throws MalformedURLException, InterruptedException {
		...
		if (bit) {
			...
			System.out.println("NoFaultInsuranceQuotes does not have Top MDA on HomePage!!!! Skipping.");
		} else {
