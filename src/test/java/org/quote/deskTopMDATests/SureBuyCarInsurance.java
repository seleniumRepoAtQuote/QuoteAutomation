...
public class SureBuyCarInsurance {
	...
	private String fileName_Excel = "surebuycarinsurance.xlsx";
	...
	public void validate_TopMDA(String urlString) throws MalformedURLException, InterruptedException {
		...
		if (bit) {
			...
			System.out.println("Skipping as SureBuyCarInsurance does not have top MDA!");
		} else {
