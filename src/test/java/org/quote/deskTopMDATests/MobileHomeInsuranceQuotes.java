...
public class MobileHomeInsuranceQuotes {
	...
	private String fileName_Excel = "mobilehomeinsurancequotes.xlsx";
	...
	public void validate_TopMDA(String urlString) throws MalformedURLException, InterruptedException {
		...
		if (bit) {
			...
			System.out.println("MobileHomeInsuranceQuotes does not have Top MDA on HomePage!!!! Skipping.");
		} else {
