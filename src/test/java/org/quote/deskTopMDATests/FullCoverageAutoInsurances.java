...
public class FullCoverageAutoInsurances {
	...
	private String fileName_Excel = "fullcoverageautoinsurances.xlsx";
	...
	public void validate_TopMDA(String urlString) throws MalformedURLException, InterruptedException {
		...
		if (bit) {
			...
			System.out.println("FullCoverageAutoInsurances does not have Top MDA on HomePage!!!! Skipping.");
		} else {
